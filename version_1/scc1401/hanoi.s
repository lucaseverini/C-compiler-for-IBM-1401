     ...
     * if(retree.statement.ExpressionStatement@513864b2:retree.statement.BlockStatement@4d5b0bc6)
     ...
     * Pop(0+X1:1)
               LCA  0+X2,0+X1
               MA   @I9I@,X2
     * if(retree.statement.BlockStatement@3511cab5:retree.statement.IfStatement@23134c4b)
     * EqualExpression(c:'%')
     * VariableExpression(c:7:false)
     * Push(7+X3:1)
               MA   @001@,X2
     ...
     * Pop(5)
     ...
     LOBAAA    NOP  
               ...
               B    LJCAAA
     LICAAA    NOP  
     * if(retree.statement.BlockStatement@47f5e1ea:retree.statement.IfStatement@5fc2ee8e)
     * EqualExpression(c:'C')
     * VariableExpression(c:7:false)
     * Push(7+X3:1)
               MA   @001@,X2
     ...
     * Pop(5)
     ...
     LPBAAA    NOP  
               ...
               B    LNCAAA
     LMCAAA    NOP  
     * if(retree.statement.BlockStatement@76bbddbf:retree.statement.IfStatement@27db637f)
     * EqualExpression(c:'S')
     * VariableExpression(c:7:false)
     * Push(7+X3:1)
               MA   @001@,X2
     ...
     * Pop(0+X1:3)
     ...
     LQBAAA    NOP  
               ...
               B    LRCAAA
     LQCAAA    NOP  
     * if(retree.statement.BlockStatement@34613b4a:retree.statement.ReturnStatement@5b7b9223)
     * EqualExpression(c:'D')
     * VariableExpression(c:7:false)
     * Push(7+X3:1)
               MA   @001@,X2
     ...
     * Pop(0+X1:3)
               LCA  0+X2,0+X1
               MA   @I9G@,X2
     * if(retree.statement.BlockStatement@3bb0ff0:retree.statement.IfStatement@6e135779)
     ...
     * Pop(0+X1:5)
     ...
     LRAAAA    NOP  
               ...
               B    LZCAAA
     LYCAAA    NOP  
     * if(retree.statement.BlockStatement@3fa768de:null)
     ...
     * and branch
     ...
     LZCAAA    NOP  
     LODAAA    NOP  
     * LessThanOrEqualExpression(exp:retree.expression.DivideExpression@7d5e778)
     ...
     * Assignment(( *(str++) )=(digits[retree.expression.DivideExpression@5627f221]))
     * SubScriptEpression(digits:retree.expression.DivideExpression@5627f221)
     ...
     * Pop(0+X1:1)
               LCA  0+X2,0+X1
               MA   @I9I@,X2
     * Assignment(value=retree.expression.ModuloExpression@588980b7)
     ...
     * Pop(0+X1:5)
               LCA  0+X2,0+X1
               MA   @I9E@,X2
     * Assignment(exp=retree.expression.DivideExpression@2b619bca)
     * Divide(exp/base)
     * VariableExpression(base:-11:false)
     * Push(15989+X3:5)
               MA   @005@,X2
     ...
     * BlockStatement(LVAAAA:null:3)
               MA   @003@,X2
     * if(retree.statement.BlockStatement@54c03bcd:retree.statement.BlockStatement@18963b33)
     * NotEqualExpression(c:'\n')
     ...
     * End asm block
     LXAAAA    NOP  
               BCE  LVAAAA,RF,R
     LBEAAA    NOP  
     * if(retree.statement.BlockStatement@5eb536e6:null)
     ...
     * BlockStatement(LWBAAA:null:3)
               MA   @003@,X2
     * if(retree.statement.BlockStatement@7c1f3f7:null)
     * EqualExpression(n:1)
     ...
     * BlockStatement(LCAAAA:null:3)
               MA   @003@,X2
     * Assignment(seed=retree.expression.ModuloExpression@205bdbdc)
