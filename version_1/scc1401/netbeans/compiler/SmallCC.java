...
public class SmallCC/*@bgen(jjtree)*/implements SmallCCTreeConstants, SmallCCConstants {/*@bgen(jjtree)*/
  ...
  public static List<Pair<String, ArrayNameExpression>> arrayLabelTable; 
  public static List<Pair<String, VariableExpression>> varLabelTable; 
  ...
  public static String getLabelForArrayVariable(ArrayNameExpression arr)
  {
		String label = label(nextLabelNumber());
		
		@SuppressWarnings("unchecked")
		Pair<String, ArrayNameExpression> p = new Pair(label, arr);		
		arrayLabelTable.add(p);
		
		return label;
  }

  public static String getLabelForVariable(VariableExpression var)
  {
		for(Pair<String, VariableExpression> pair : varLabelTable) 
		{
			if(pair.b == var)
			{
				return pair.a;
		...
		@SuppressWarnings("unchecked")
		Pair<String, VariableExpression> p = new Pair(label, var);		
		varLabelTable.add(p);
  ...
  public static int compile(String inputFile, String outputFile, int stackLoc, int codeLoc, int dataLoc) throws Exception
  {
	...
	arrayLabelTable = new ArrayList<>();
	varLabelTable = new ArrayList<>();
