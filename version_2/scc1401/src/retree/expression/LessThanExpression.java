...
*/
    ...
    public String generateCode(boolean valueNeeded)
	{
		...
		if (valueNeeded)
		{
            Optimizer.addInstruction("Less (<) " + this.toString(),"","");
            ...
            Optimizer.addInstruction("Jump if less", "", "BL", labelLessThan);
            ...
            Optimizer.addInstruction("Less: Set stack location to 1", labelLessThan, "MCW", NUM_CONST(1, false), STACK_OFF(0));
			code += INS("Less: Set stack location to 1", labelLessThan, "MCW", NUM_CONST(1, false), STACK_OFF(0));
            Optimizer.addInstruction("End of Less", labelEnd, "NOP");
