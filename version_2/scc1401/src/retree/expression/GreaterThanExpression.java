...
public class GreaterThanExpression extends Expression
{
    ...
    public String generateCode(boolean valueNeeded)
	{
		if (valueNeeded)
		{
			Optimizer.addInstruction("Greater (>) " + this.toString(),"","");
			...
			Optimizer.addInstruction("Jump if more than..", "", "BH", labelMoreThan);
			...
			Optimizer.addInstruction("MoreThan: Set stack location to 1", labelMoreThan, "MCW", NUM_CONST(1, false), STACK_OFF(0));
			code += INS("MoreThan: Set stack location to 1", labelMoreThan, "MCW", NUM_CONST(1, false), STACK_OFF(0));
			Optimizer.addInstruction("End of Greater", labelEnd, "NOP");
