...
public class GreaterThanOrEqualExpression extends Expression
{
    ...
    public String generateCode(boolean valueNeeded)
	{
		if (valueNeeded)
		{
			...
			Optimizer.addInstruction("GreaterOrEqual (>=) (" + this.toString(),"","");
			...
			Optimizer.addInstruction("Jump if greater or equal", "", "BL", labelLessThan);
			...
			Optimizer.addInstruction("GreaterOrEqual: Set stack location to 0", labelLessThan, "MCW", NUM_CONST(0, false), STACK_OFF(0));
			code += INS("GreaterOrEqual: Set stack location to 0", labelLessThan, "MCW", NUM_CONST(0, false), STACK_OFF(0));
			Optimizer.addInstruction("End of GreaterOrEqual", labelEnd, "NOP");
