...
public class FunctionCallExpression extends Expression
{
	...
	{
		Optimizer.addInstruction("Function Call " + this.toString(),"","");
		...
		// Make a new frame
		code += PUSH(3, "X3");
		Optimizer.addInstruction("Copy X2 into X3", "", "MCW", "X2", "X3");
		code += INS("Copy X2 into X3", null, "MCW", "X2", "X3");

		// Branch
		String name = SmallCC.getFunctionNameFromExpression(function);
		Optimizer.addInstruction("Jump to function " + name, "", "B", label(function.getValue()));
