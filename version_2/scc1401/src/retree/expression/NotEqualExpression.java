...
public class NotEqualExpression extends Expression
{
	...
	public String generateCode(boolean valueNeeded)
	{
		...
		Optimizer.addInstruction("NotEqual (!=) " + this.toString(),"","");
		...
		if (valueNeeded)
		{
			...
			Optimizer.addInstruction("Equal: Set stack location to 0", labelEqual, "MCW", NUM_CONST(0, false), STACK_OFF(0));
			code += INS("Equal: Set stack location to 0", labelEqual, "MCW", NUM_CONST(0, false), STACK_OFF(0));
			Optimizer.addInstruction("End of NotEqual", labelEnd, "NOP");
